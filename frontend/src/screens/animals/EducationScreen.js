...
const INFOGRAPHICS = [
  ...
  },
  {
    ...
    type: "Life Cycle",
    imageUrl: "https://images.unsplash.com/photo-1544342882-14d442999651?q=80&w=800&auto=format&fit=crop",
...
const REGIONS = [
  { id: 'africa', name: 'Africa', icon: '🌍', animals: ['Lion', 'Elephant', 'Giraffe', 'Zebra'], top: '55%', left: '50%' },
  { id: 'asia', name: 'Asia', icon: '🌏', animals: ['Tiger', 'Panda', 'Snow Leopard'], top: '40%', left: '70%' },
  { id: 'americas', name: 'Americas', icon: '🌎', animals: ['Jaguar', 'Bald Eagle', 'Bison'], top: '45%', left: '25%' },
  { id: 'australia', name: 'Australia', icon: '🇦🇺', animals: ['Kangaroo', 'Koala', 'Platypus'], top: '75%', left: '85%' },
];
