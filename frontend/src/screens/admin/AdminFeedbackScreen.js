...
export default function AdminFeedbackScreen() {
  ...
  const handleDeleteReply = (item) => {
    Alert.alert('Delete Response', 'Are you sure you want to remove this response?', [
  ...
  return (
    <ScreenContainer scroll={false} backgroundColor={theme.colors.backgroundAlt}>
        ...
        <View style={styles.filterContainer}>
          <FlatList
            ...
            renderItem={({ item: typeItem }) => (
              <TouchableOpacity
                style={[styles.filterChip, filterType === typeItem && styles.activeFilterChip]}
                onPress={() => setFilterType(typeItem)}
              >
                <Text style={[styles.filterChipText, filterType === typeItem && styles.activeFilterChipText]}>
                  {typeItem}
                </Text>
              </TouchableOpacity>
            )}
      ...
      <FlatList
        ...
        refreshControl={
          <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[theme.colors.accentGreen]} />
        }
        ListEmptyComponent={
          !loading && (
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity style={[styles.modalBtn, styles.cancelBtn]} onPress={() => setShowReplyModal(false)}>
              ...
              >
                <Text style={styles.submitBtnText}>{replyLoading ? 'Sending...' : 'Send Reply'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        </View>
